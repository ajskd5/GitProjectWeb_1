...
public class SeoulDAO {
   ...
   // 상세보기<select id="seoullnsDetailData" resultType="SeoulLNSVO" parameterType="hashmap">
   public static SeoulLNSVO seoullnsDetailData(Map map) {
	   ...
	   try {
		   ...
		   vo = session.selectOne("seoullnsDetailData", map);
			...
			System.out.println("seoullnsDetailData : error");
			e.printStackTrace();
		} finally {
			if(session!=null) {
				session.close();
